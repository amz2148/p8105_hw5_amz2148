...
* Finally, we make 2 plots: one plot showing the average estimate of mu-hat on the y axis and the true value of mu on the x axis, and a second plot with the average estimate of mu-hat  only in samples for which the null was rejected on the y axis and the true value of mu on the x axis. 
